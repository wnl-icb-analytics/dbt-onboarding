...
export function AnnotatedCode({
  ...
  return (
    <figure className="my-5 w-full min-w-0 max-w-[76ch] overflow-hidden rounded-xl border border-white/10 bg-graphite-deep shadow-[0_8px_30px_-12px_rgb(0_0_0/0.45)]">
