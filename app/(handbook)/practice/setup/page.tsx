...
`}
      ...
      <Callout kind="warn" title="Know where query output goes">
        <p>
          ...
          only for synthetic or non-identifying results, or when the tool has approved
          zero-data-retention controls for the data. Otherwise inspect rows in an
          approved human-controlled tool.
        </p>
      </Callout>
